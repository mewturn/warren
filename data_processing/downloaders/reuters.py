...
def getURL():
    pre = "https://uk.reuters.com/business/stocks/company-profile/%s.HK"
...
def getText(url, lang):
    ...
    web = resp.read()
    soup = BeautifulSoup(web, "lxml")
    content = soup.findAll("div", {"class" : "moduleBody"})
...
"80737",
"84602"]
    cn_link = "https://cn.reuters.com/investing/stocks/profile/%s.HK"
    en_link = "https://uk.reuters.com/business/stocks/company-profile/%s.HK"
    dir = "temp_reuters/"
    processed = set()
    for i in codes:
        try:
